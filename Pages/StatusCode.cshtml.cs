...
public class StatusCodeModel : PageModel {
	...
	public void OnGet(int statusCode) {
		...
		ViewData["Title"] = Title =
			titles.TryGetValue(statusCode, out var title) ? title : $"{statusCode} | Status Code Not Found";

		ViewData["Keywords"] = "LC,网站,测试,错误,HTTP 状态码";

		ViewData["Description"] = Description =
			descriptions.TryGetValue(statusCode, out var description) ? description : "我们无法确认当前的状态码的意义，未能判断发生了什么！";
	}
